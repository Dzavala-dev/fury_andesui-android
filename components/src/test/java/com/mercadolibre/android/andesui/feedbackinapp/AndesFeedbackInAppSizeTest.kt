...
import com.mercadolibre.android.andesui.feedbackinapp.factory.FeedbackInAppIconConfig
import com.mercadolibre.android.andesui.feedbackinapp.hierarchy.AndesFeedbackInAppHierarchyInterface
import com.mercadolibre.android.andesui.feedbackinapp.size.AndesLargeButtonSize
import com.mercadolibre.android.andesui.feedbackinapp.size.AndesMediumButtonSize
import com.mercadolibre.android.andesui.feedbackinapp.size.AndesSmallButtonSize
...
class AndesLargeButtonSizeTest {
    ...
    private var hierarchy = Mockito.mock(AndesFeedbackInAppHierarchyInterface::class.java)
    ...
    fun `Large button left icon`() {
        assertEquals(andesLargeButtonSize.iconConfig(hierarchy, ANDES_ICON, null, context), FeedbackInAppIconConfig(icon, null))
    }

    @Test
    fun `Large button right icon`() {
        assertEquals(andesLargeButtonSize.iconConfig(hierarchy, null, ANDES_ICON, context), FeedbackInAppIconConfig(null, icon))
    }
}
